...
export default function Community() {
  return (
    <section className="bg-[#88b62c6b] py-20 relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 text-center relative">
        ...
        <img
          src={heartIcon}
          alt="Heart"
          className="hidden md:block absolute right-6 top-0 w-20 opacity-40"
        />

        {/* Heading */}
        <h2 className="text-[#144a36] text-4xl md:text-5xl font-bold leading-tight">
          More Than a Platform, A Community for Pets
        </h2>

        {/* Description */}
        <p className="mt-8 text-lg md:text-2xl text-gray-800 max-w-3xl mx-auto">
