...
export default function Community() {
  return (
    <section className="bg-[#88b62c]/40 py-30 relative overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 text-center relative">
        ...
        <img
          src={heartIcon}
          alt="Heart"
          className="hidden md:block absolute right-6 -top-23 md:right-70 lg:right-120 w-100 opacity-40"
        />
        ...
        {/* Description */}
        <p className="mt-8 text-lg lg:text-3xl md:text-2xl text-black max-w-3xl mx-auto">
