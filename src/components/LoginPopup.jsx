    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="relative bg-white rounded-3xl shadow-2xl w-[90%] max-w-md p-8">
        ...
        <div className="mt-8">
          ...
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" className="w-full mt-2 border-2 border-gray-300 rounded-xl p-3 focus:border-[#88b62c] focus:outline-none" />
        </div>
        <div className="mt-5">
          <label className="font-semibold text-lg">Password</label>
          <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" className="w-full mt-2 border-2 border-gray-300 rounded-xl p-3 focus:border-[#88b62c] focus:outline-none" />
        </div>
