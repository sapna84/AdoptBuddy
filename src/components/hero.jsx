  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-20 md:top-15 left-2 md:left-10 lg:left-18">
        ...
        <button className="mt-10 lg:mt-25 ml-12 md:ml-23 lg:ml-50 bg-[#144a36] text-white md:text-2xl lg:text-3xl lg:text-4xl px-6 py-5 lg:px-10 lg:py-7 rounded-xl font-bold cursor-pointer">
          Adopt Now
        </button>
      </div>
    </section>
