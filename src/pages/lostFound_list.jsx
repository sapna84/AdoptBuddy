...
export default function LostFoundList() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f1e6]">
      ...
      {/* Tabs */}
      <section className="mx-autop py-10 px-10 lg:px-6">
        <div className="flex border-b border-gray-300">
          <button
            onClick={() => setActiveTab("lost")}
            className={`pb-3 lg:ml-10 ml-4 lg:px-20 lg:text-4xl text-3xl font-bold cursor-pointer transition ${
              activeTab === "lost"
          ...
          <button
            ...
            className={`pb-3 lg:ml-10 ml-25 lg:px-20 lg:text-4xl text-3xl font-bold cursor-pointer transition ${
              activeTab === "found"
                ? "text-[#88b62c] border-b-4 border-[#88b62c]"
                : "text-[#144a36]"
            }`}
